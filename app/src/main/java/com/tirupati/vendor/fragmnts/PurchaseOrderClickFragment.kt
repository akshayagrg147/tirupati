 ...
 * Use the [PurchaseOrderClickFragment.newInstance] factory method to
...
class PurchaseOrderClickFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_purchase_order_click, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment PurchaseOrderClickFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PurchaseOrderClickFragment().apply {
