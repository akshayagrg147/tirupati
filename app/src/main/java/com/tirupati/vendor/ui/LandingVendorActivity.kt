...
@AndroidEntryPoint
class LandingVendorActivity : AppCompatActivity(), ToolbarTitleChangeListener {
    ...
    lateinit var binding: VendorLandingScreenActivityBinding
    ...
    companion object{
        ...
        fun changeTitle(title:String){
            if(toolbarV !=null){
                val titleTextVw = LandingVendorActivity.toolbarV!!.findViewById<TextView>(R.id.toolbarTitle)
...
//        setContentView(R.layout.landing_screen)
        binding = VendorLandingScreenActivityBinding.inflate(layoutInflater)
        ...
        lifecycleScope.launch {
            ...
            when (response) {
                ...
                is NetworkState.Error<*> -> {
                    binding!!.loginProgressBar.progressBar.hidden()
                    showCustomDialog(this@LandingVendorActivity, response.msg.toString(),"Error")
                ...
                is NetworkState.HttpErrors.ResourceNotFound -> {
                    ...
                    binding!!.loginProgressBar.progressBar.hidden()
                    showCustomDialog(this@LandingVendorActivity, "something went wrong","Error")
                }
            }
