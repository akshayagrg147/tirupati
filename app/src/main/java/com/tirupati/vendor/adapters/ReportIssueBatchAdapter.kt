...
class ReportIssueBatchAdapter(context: Context,
                              @LayoutRes private val layoutResource: Int,
                              private val values: ArrayList<BatchDetail>)
    : ArrayAdapter<BatchDetail>(context, layoutResource, values) {

    override fun getItem(position: Int): BatchDetail = values[position]
    ...
    private fun bindData(value: BatchDetail, view: TextView): TextView {
        view.text = value.batchCode
        return view
    }
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        label.setText(this.getItem(position).batchCode)
        label.setPadding(
            20,
            30,
            0,
